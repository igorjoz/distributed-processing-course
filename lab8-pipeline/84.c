...
// 1. uruchomić, sprawdzić jak działa
// 2. usunąć ograniczenia sekcji krytycznej - lock & unlock
// 2.2 sprawdzić jak zmniniło się działanie programu


// przy inicjalizacji strumienia więcej elementów